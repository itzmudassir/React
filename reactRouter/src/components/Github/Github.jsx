...
function Github() {
  ...
  return (
	...
	<img src={data.avatar_url} alt="" class="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square"/>
...
export const githubInfoLoader = async () => {
    const response = await fetch('https://api.github.com/users/itzmudassir')
